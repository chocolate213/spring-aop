 ...
 * LoggingWithinAspect
 *
 * within表示指定域的所有类中的所有方法匹配切点：StudentServiceImpl与TeacherServiceImpl中的所有方法
 *
 * @author zhangjiaxing
 * @version 1.0
 */
@Component
@Aspect
public class LoggingWithinAspect {
    /**
     * 前置通知：在目标方法开始执行前执行
     *
     ...
     */
    @Before("within(cn.jxzhang.demo.spring.service.impl.*)")
     ...
     * @param joinPoint join point
     */
    @After("within(cn.jxzhang.demo.spring.service.impl.*)")
     ...
     * @param result    返回结果
     */
    @AfterReturning(value = "within(cn.jxzhang.demo.spring.service.impl.*)", returning = "result")
     ...
     */
    @AfterThrowing(value = "within(cn.jxzhang.demo.spring.service.impl.*)", throwing = "exception")
