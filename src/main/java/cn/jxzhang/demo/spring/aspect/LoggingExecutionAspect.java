...
/**
 * LoggingExecutionAspect
 *
 * execution: 当方法签名匹配表达式时，切点匹配
 *
 * @author zhangjiaxing
 * @version 1.0
 */
...
public class LoggingExecutionAspect {
     ...
     */
    @Before("execution(* cn.jxzhang.demo.spring.service.impl.StudentServiceImpl.*(..))")
     ...
     * @param joinPoint join point
     */
    @After("execution(* cn.jxzhang.demo.spring.service.impl.StudentServiceImpl.*(..))")
     ...
     * @param result    返回结果
     */
    @AfterReturning(value = "execution(* cn.jxzhang.demo.spring.service.impl.StudentServiceImpl.*(..))", returning = "result")
     ...
     */
    @AfterThrowing(value = "execution(* cn.jxzhang.demo.spring.service.impl.StudentServiceImpl.*(..))", throwing = "exception")
