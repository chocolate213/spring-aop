...
/**
 * LoggingArgsAnnotationAspect
 *
 * 当目标方法传入带有指定注解的入参时，方法匹配。（方法入参必须完全匹配，多个入参使用逗号分隔开）
 *
 * @author zhangjiaxing
 * @version 1.0
 */
@Aspect
@Component
public class LoggingArgsAnnotationAspect {
     ...
     */
    @Before("@args(cn.jxzhang.demo.spring.annotation.LoggingOnArg)")
     ...
     * @param joinPoint join point
     */
    @After("@args(cn.jxzhang.demo.spring.annotation.LoggingOnArg)")
     ...
     * @param result    返回结果
     */
    @AfterReturning(value = "@args(cn.jxzhang.demo.spring.annotation.LoggingOnArg)", returning = "result")
     ...
     */
    @AfterThrowing(value = "@args(cn.jxzhang.demo.spring.annotation.LoggingOnArg, cn.jxzhang.demo.spring.annotation.LoggingOnArg)", throwing = "exception")
