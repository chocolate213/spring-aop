...
/**
 * LoggingWithinAnnotationAspect
 *
 * <code>@within</code> 表示标记了指定注解的所有方法匹配切点
 *
 * @author zhangjiaxing
 * @version 1.0
 */
@Component
@Aspect
public class LoggingWithinAnnotationAspect {
    /**
     * 前置通知：在目标方法开始执行前执行
     *
     ...
     */
    @Before("@within(cn.jxzhang.demo.spring.annotation.LoggingOnClass)")
     ...
     * @param joinPoint join point
     */
    @After("@within(cn.jxzhang.demo.spring.annotation.LoggingOnClass)")
     ...
     * @param result    返回结果
     */
    @AfterReturning(value = "@within(cn.jxzhang.demo.spring.annotation.LoggingOnClass)", returning = "result")
     ...
     */
    @AfterThrowing(value = "@within(cn.jxzhang.demo.spring.annotation.LoggingOnClass)", throwing = "exception")
